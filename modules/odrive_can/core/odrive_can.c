...
/****************************************************************************/
static int  odrive_can_send_cmd(uint8_t node_id, uint8_t cmd_id,
...
/*							Global Variables								*/
/****************************************************************************/
static const odrive_can_driver_t *g_driver;
...
void odrive_can_set_axis_state(uint8_t node_id, uint8_t axis_state)
{
    uint8_t data[8] = {0};
    data[0] = axis_state;
    odrive_can_send_cmd(node_id, CAN_CMD_SET_AXIS_STATE, data, 8);
}
...
void odrive_can_set_ctrl_mode(uint8_t node_id, uint8_t ctrl_mode, uint8_t input_mode)
{
    ...
    data[0] = ctrl_mode;
    data[1] = input_mode;
    odrive_can_send_cmd(node_id, CAN_CMD_SET_CTRL_MODE, data, 8);
}
...
void odrive_can_set_input_pos(uint8_t node_id, float pos, int16_t vel_ff, int16_t torque_ff)
{
    ...
    odrive_can_send_cmd(node_id, CAN_CMD_SET_INPUT_POS, data, 8);
}
...
void odrive_can_set_input_vel(uint8_t node_id, float vel, float torque_ff)
{
    ...
    odrive_can_send_cmd(node_id, CAN_CMD_SET_INPUT_VEL, data, 8);
}
...
void odrive_can_set_input_torque(uint8_t node_id, float torque)
{
    ...
    odrive_can_send_cmd(node_id, CAN_CMD_SET_INPUT_TORQUE, data, 8);
}
...
void odrive_can_set_vel_limit(uint8_t node_id, float vel_limit)
{
    ...
    odrive_can_send_cmd(node_id, CAN_CMD_SET_VEL_LIMIT, data, 8);
}
...
void odrive_can_set_traj_vel_limit(uint8_t node_id, float traj_vel_limit)
{
    ...
    odrive_can_send_cmd(node_id, CAN_CMD_SET_TRAJ_VEL_LIMIT, data, 8);
}
...
void odrive_can_set_traj_accel_limit(uint8_t node_id, float traj_accel_limit, float traj_decel_limit)
{
    ...
    odrive_can_send_cmd(node_id, CAN_CMD_SET_TRAJ_ACCEL_LIMIT, data, 8);
}
...
void odrive_can_set_pos_gain(uint8_t node_id, float pos_gain)
{
    ...
    odrive_can_send_cmd(node_id, CAN_CMD_SET_POS_GAIN, data, 8);
}
...
void odrive_can_set_vel_gains(uint8_t node_id, float vel_gain, float vel_integrator_gain)
{
    ...
    odrive_can_send_cmd(node_id, CAN_CMD_SET_VEL_GAINS, data, 8);
}

void odrive_can_reboot(uint8_t node_id)
{
    odrive_can_send_cmd(node_id, CAN_CMD_REBOOT, NULL, 0);
}

void odrive_can_clear_errors(uint8_t node_id)
{
    odrive_can_send_cmd(node_id, CAN_CMD_CLEAR_ERRORS, NULL, 0);
}

void odrive_can_estop(uint8_t node_id)
{
    odrive_can_send_cmd(node_id, CAN_CMD_ESTOP, NULL, 0);
}
