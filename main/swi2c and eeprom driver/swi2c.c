...
#define SDA_IN()  {I2C_GPIO_PORT->MODER &= ~(3 << 1 * 2);GPIOC->MODER = (0 << 1 * 2);}
#define SDA_OUT() {I2C_GPIO_PORT->MODER &= ~(3 << 1 * 2);GPIOC->MODER = (1 << 1 * 2);}

// #define SDA_IN()        do{GPIO_InitTypeDef GPIO_InitStruct = {0};GPIO_InitStruct.Mode = GPIO_MODE_INPUT;\
//                             HAL_GPIO_Init(I2C_GPIO_PORT, &GPIO_InitStruct);}while(0)
// #define SDA_OUT()       do{GPIO_InitTypeDef GPIO_InitStruct = {0};GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;\
//                             HAL_GPIO_Init(I2C_GPIO_PORT, &GPIO_InitStruct);}while(0)
