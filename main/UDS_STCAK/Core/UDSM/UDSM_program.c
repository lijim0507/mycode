...
static Commands_t const Commands_Table[] = {{Reserved0, Non_Service, NULL},
...
static Data_By_Id const Data_Table[] = {{0xF3A0, (u8 *)data_1, 3, DATA_WR_R, Multi_Session, Extened, Multi_Level, Level1},
...
STATUES Packet_Process(Packet_Handler_t *const Data)
{
    ...
    if (Commands_Table[Data[0].SID].Implemention != NULL && Data[0].SID < 0x40)
    {
        ...
        PacketResult = (Commands_Table[Data[0].SID].Implemention)(&Data[Package_Target]);
    }
