...
static int esp32_swi2c_init(void *config);
static int esp32_swi2c_deinit(void);
static void esp32_sda_set(uint8_t level);
static void esp32_scl_set(uint8_t level);
static uint8_t esp32_sda_get(void);
static void esp32_delay_us(void);

/****************************************************************************/
/*                          Global Variables                                */
/****************************************************************************/

static esp32_swi2c_ctx_t g_swi2c_ctx;
...
/**
 * @brief  获取 ESP32 GPIO 位带 I2C 驱动实例
 * @return swi2c_driver_t 结构体指针
 */
const swi2c_driver_t *swi2c_port_get_driver(void)
{
    static const swi2c_driver_t driver = {
        .init      = esp32_swi2c_init,
        .deinit    = esp32_swi2c_deinit,
        .sda_set   = esp32_sda_set,
        .scl_set   = esp32_scl_set,
        .sda_get   = esp32_sda_get,
